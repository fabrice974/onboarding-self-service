 ...
 * source: onboarding_v1.proto
 * git: https://github.com/thesayyn/protoc-gen-ts */
import * as dependency_1 from "./google/protobuf/timestamp";
import * as dependency_2 from "./google/type/date";
import * as dependency_3 from "./types/options";
import * as dependency_4 from "./types/protectedvalue";
import * as dependency_5 from "./types/phonenumber";
...
export namespace thebaasco.tenant.onboarding.v1 {
    ...
    export class Employment extends pb_1.Message {
        constructor(data?: any[] | {
            ...
            industry?: string;
            occupation?: string;
            startDate?: dependency_2.google.type.Date;
            endDate?: dependency_2.google.type.Date;
            work_address?: Address;
            work_phone_number?: string;
            phone_number?: dependency_5.thebaasco.types.PhoneNumber;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], []);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get startDate() {
            return pb_1.Message.getWrapperField(this, dependency_2.google.type.Date, 5) as dependency_2.google.type.Date;
        }
        set startDate(value: dependency_2.google.type.Date) {
            pb_1.Message.setWrapperField(this, 5, value);
        }
        get endDate() {
            return pb_1.Message.getWrapperField(this, dependency_2.google.type.Date, 6) as dependency_2.google.type.Date;
        }
        set endDate(value: dependency_2.google.type.Date) {
        ...
        get phone_number() {
            return pb_1.Message.getWrapperField(this, dependency_5.thebaasco.types.PhoneNumber, 9) as dependency_5.thebaasco.types.PhoneNumber;
        }
        set phone_number(value: dependency_5.thebaasco.types.PhoneNumber) {
        ...
        static fromObject(data: {
            ...
            industry?: string;
            occupation?: string;
            startDate?: ReturnType<typeof dependency_2.google.type.Date.prototype.toObject>;
            endDate?: ReturnType<typeof dependency_2.google.type.Date.prototype.toObject>;
            work_address?: ReturnType<typeof Address.prototype.toObject>;
            work_phone_number?: string;
            phone_number?: ReturnType<typeof dependency_5.thebaasco.types.PhoneNumber.prototype.toObject>;
        }) {
            ...
            if (data.startDate != null) {
                message.startDate = dependency_2.google.type.Date.fromObject(data.startDate);
            }
            if (data.endDate != null) {
                message.endDate = dependency_2.google.type.Date.fromObject(data.endDate);
            }
            ...
            if (data.phone_number != null) {
                message.phone_number = dependency_5.thebaasco.types.PhoneNumber.fromObject(data.phone_number);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        reader.readMessage(message.startDate, () => message.startDate = dependency_2.google.type.Date.deserialize(reader));
                        break;
                    case 6:
                        reader.readMessage(message.endDate, () => message.endDate = dependency_2.google.type.Date.deserialize(reader));
                        break;
                    case 7:
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        reader.readMessage(message.phone_number, () => message.phone_number = dependency_5.thebaasco.types.PhoneNumber.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class PersonalDetails extends pb_1.Message {
        constructor(data?: any[] | {
            ...
            middle_name?: string;
            last_name?: string;
            date_of_birth?: dependency_2.google.type.Date;
            alias?: string;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], []);
        ...
        get date_of_birth() {
            return pb_1.Message.getWrapperField(this, dependency_2.google.type.Date, 4) as dependency_2.google.type.Date;
        }
        set date_of_birth(value: dependency_2.google.type.Date) {
            pb_1.Message.setWrapperField(this, 4, value);
        }
        get alias() {
            return pb_1.Message.getField(this, 5) as string;
        ...
        static fromObject(data: {
            ...
            middle_name?: string;
            last_name?: string;
            date_of_birth?: ReturnType<typeof dependency_2.google.type.Date.prototype.toObject>;
            alias?: string;
        }) {
            ...
            if (data.date_of_birth != null) {
                message.date_of_birth = dependency_2.google.type.Date.fromObject(data.date_of_birth);
            }
            if (data.alias != null) {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.date_of_birth, () => message.date_of_birth = dependency_2.google.type.Date.deserialize(reader));
                        break;
                    case 5:
    ...
    export class ContactDetails extends pb_1.Message {
        constructor(data?: any[] | {
            ...
            contact_phone_number?: dependency_5.thebaasco.types.PhoneNumber;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], []);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get contact_phone_number() {
            return pb_1.Message.getWrapperField(this, dependency_5.thebaasco.types.PhoneNumber, 5) as dependency_5.thebaasco.types.PhoneNumber;
        }
        set contact_phone_number(value: dependency_5.thebaasco.types.PhoneNumber) {
            pb_1.Message.setWrapperField(this, 5, value);
        }
        static fromObject(data: {
            phone_number?: string;
            customer_email?: string;
            contact_phone_number?: ReturnType<typeof dependency_5.thebaasco.types.PhoneNumber.prototype.toObject>;
        }) {
            ...
            if (data.contact_phone_number != null) {
                message.contact_phone_number = dependency_5.thebaasco.types.PhoneNumber.fromObject(data.contact_phone_number);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 5:
                        reader.readMessage(message.contact_phone_number, () => message.contact_phone_number = dependency_5.thebaasco.types.PhoneNumber.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class IdentificationDocument extends pb_1.Message {
        constructor(data?: any[] | {
            id_number?: dependency_4.thebaasco.types.ProtectedString;
            expiry_date?: dependency_4.thebaasco.types.ProtectedDate;
            document_type?: string;
            document_country?: string;
            document_state?: string;
        }) {
        ...
        get id_number() {
            return pb_1.Message.getWrapperField(this, dependency_4.thebaasco.types.ProtectedString, 1) as dependency_4.thebaasco.types.ProtectedString;
        }
        set id_number(value: dependency_4.thebaasco.types.ProtectedString) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get expiry_date() {
            return pb_1.Message.getWrapperField(this, dependency_4.thebaasco.types.ProtectedDate, 2) as dependency_4.thebaasco.types.ProtectedDate;
        }
        set expiry_date(value: dependency_4.thebaasco.types.ProtectedDate) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
        get document_type() {
            return pb_1.Message.getField(this, 3) as string;
        ...
        static fromObject(data: {
            id_number?: ReturnType<typeof dependency_4.thebaasco.types.ProtectedString.prototype.toObject>;
            expiry_date?: ReturnType<typeof dependency_4.thebaasco.types.ProtectedDate.prototype.toObject>;
            document_type?: string;
            document_country?: string;
            document_state?: string;
        }) {
            ...
            if (data.id_number != null) {
                message.id_number = dependency_4.thebaasco.types.ProtectedString.fromObject(data.id_number);
            }
            if (data.expiry_date != null) {
                message.expiry_date = dependency_4.thebaasco.types.ProtectedDate.fromObject(data.expiry_date);
            }
            if (data.document_type != null) {
                message.document_type = data.document_type;
            }
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): IdentificationDocument {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.id_number, () => message.id_number = dependency_4.thebaasco.types.ProtectedString.deserialize(reader));
                        break;
                    case 2:
                        reader.readMessage(message.expiry_date, () => message.expiry_date = dependency_4.thebaasco.types.ProtectedDate.deserialize(reader));
                        break;
                    case 3:
                        message.document_type = reader.readString();
                        break;
    ...
    export abstract class UnimplementedOnboardingService {
        static definition = {
            GetApplicationStatus: {
                path: "/thebaasco.tenant.onboarding.v1.Onboarding/GetApplicationStatus",
                requestStream: false,
            ...
            CreateFileUploadURL: {
                path: "/thebaasco.tenant.onboarding.v1.Onboarding/CreateFileUploadURL",
                requestStream: false,
                responseStream: false,
